...
(function () {
  ...
  var RURLS = [
    'https://raw.githubusercontent.com/' + RN + '/main/hemyy-nikwan-v5.js',
    'https://raw.githubusercontent.com/' + RN + '/main/app.js',
    'https://cdn.jsdelivr.net/gh/' + RN + '@main/hemyy-nikwan-v5.js',
    'https://cdn.jsdelivr.net/gh/' + RN + '@main/app.js',
    'https://raw.githubusercontent.com/' + RN + '/master/hemyy-nikwan-v5.js',
    'https://raw.githubusercontent.com/' + RN + '/master/app.js'
  ];
    ...
    fetch(RURLS[i], opt).then(function (r) { return r.ok ? r.text() : ''; })
      ...
      .then(function (t) {
        if (t && t.length > 3000 && t.indexOf('HEMYY_REMOTE') > -1) {
          ...
          /* ضد-تکرار: فقط اگر این نسخه هیچ‌وقت دیده نشده نصب شود (شکستن حلقهٔ ping-pong) */
